...
<main>
    <div class="card first-card mb-3">
        <div class="row g-0">
            <div class="col-md-4">
                <img src="/img/{{ $car->list_image }}" alt="..." class="container-fluid car-image">
            </div>
            <div class="col-md-8">
                <div class="card-body">
                    <h6 class="card-subtitle mb-2 text-muted text-capitalize">{{ $car->model }}</h6>
